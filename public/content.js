(function () {
	...
	const generateblackBkg = () => {
	    ...
	    backdropDiv.setAttribute("style", "z-index: 1000; position: absolute; top: 0; left: 0; background-color: #0D2D44; height: 100vh; width: 100vw; display: flex; align-items: center; justify-content: center");
	    return backdropDiv;
	};
	const showBlackListedDomain = () => {
	    const alertDiv = document.createElement("div");
	    alertDiv.setAttribute("style", "color: #525252; top: 0; background-color: white; height: 100px; padding: 20px; display: flex; align-items: center; font-size: 1.5rem");
	    const alertMessage = document.createTextNode("This domain is forbiden. The tab will be closed");
	    alertDiv.appendChild(alertMessage);
	...
	const createMarqueeBanner = (elemType, elemText) => {
	    ...
	    banner.setAttribute("style", "z-index: 1000; position: sticky; top: 0; background-color: #0D2D44; line-height: 1; padding: 10px;");
	...
	// ***** Init ******
	document.body.prepend(createMarqueeBanner("span", "NinjaOne: Secured Browser Extension is running"));
